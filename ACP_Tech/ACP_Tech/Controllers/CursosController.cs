...
namespace ACP_Tech.Controllers
{
    public class CursosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Valor,CargaHoraria")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Valor,CargaHoraria")] Curso curso)
        {
            if (id != curso.Id)
            {
                return NotFound();
